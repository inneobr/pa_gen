...
@Data
public class NaturezaOperacaoDtoEstabelecimentos {
	...
	private String modFixSemPjCnjCoop;
	private String natDevFixPjCnfCoop;
	private String serDevFixPjCnfCoop;
	private String modDevFixPjCnjCoop;
	...
	private List<EstabelecimentoDto> listEstabelecimentoDto;
	
	public static NaturezaOperacaoDtoEstabelecimentos construir(NaturezaOperacao naturezaOperacao, List<NaturezaOperacaoEstabelecimento> estabelecimentoList) {
		NaturezaOperacaoDtoEstabelecimentos naturezaOperacaoDto = new NaturezaOperacaoDtoEstabelecimentos();
