...
@Data
public class SementeLaudoInspecaoSimplesResponseDto extends AbstractResponseDto implements Serializable {
    ...
    public static SementeLaudoInspecaoSimplesResponseDto construir(SementeLaudoInspecaoSimplesDto dto, Boolean integrated, String message) {
        var sementeCampoResponseDto = new SementeLaudoInspecaoSimplesResponseDto();
    ...
    public static SementeLaudoInspecaoSimplesResponseDto construir(SementeLaudoInspecaoSimplesDto dto, Boolean integrated, String message, Exception exception) {
        var sementeCampoResponseDto = new SementeLaudoInspecaoSimplesResponseDto();
        BeanUtils.copyProperties(dto, sementeCampoResponseDto);
    ...
    public static SementeLaudoInspecaoSimplesResponseDto construir(SementeLaudoInspecaoSimplesDto dto, Boolean integrated, String message, ConstraintViolationException exception) {
        var objDto = new SementeLaudoInspecaoSimplesResponseDto();
